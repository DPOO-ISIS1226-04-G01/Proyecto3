...
public class LoginAdmin extends JFrame implements ActionListener{
	...
	public LoginAdmin(Aplicacion consola12) {
		consola1 = consola12;
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if (comando.equals(INICIAR) && consola1.iniciarAdminInterfaz(campoLogin.getText(),campoPassword.getText())) {
			menu = new MenuAdmin(consola1);
			menu.setVisible(true);
			setVisible(false);
		}else if (comando.equals(INICIAR) && (consola1.iniciarAdminInterfaz(campoLogin.getText(),campoPassword.getText()) == false)) {
